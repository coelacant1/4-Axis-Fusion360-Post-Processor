description = "Coela 4-Axis";
vendor = "Coela";
vendorUrl = "";
legal = "Copyright (C) 2022 by Coelacanth Electronics, LLC";
certificationLevel = 2;
minimumRevision = 45793;

longDescription = "Coela GCODE post for 4-axis laser.";
...
properties = {
  ...
  workSpaceOffsetX: {
    title      : "Workspace offset X",
    description: "Enter the X-Axis workspace offset",
    group      : "Work Space Offset",
    type       : "number",
    value      : 0,
    scope      : "post"
  },
  workSpaceOffsetY: {
    title      : "Workspace offset Y",
    description: "Enter the Y-Axis workspace offset",
    group      : "Work Space Offset",
    type       : "number",
    value      : 0,
    scope      : "post"
  ...
  workSpaceOffsetZ: {
    title      : "Workspace offset Z",
    description: "Enter the Z-Axis workspace offset",
    group      : "Work Space Offset",
    type       : "number",
    value      : 0,
    scope      : "post"
...
var bOutput = createVariable({prefix:"E"}, abcFormat);
...
function onRapid5D(_x, _y, _z, _a, _b, _c) {
  ...
  if (b){
    ...
    x = xOutput.format(_x * Math.cos(-1 * _b) - _y * Math.sin(-1 * _b) + getProperty("workSpaceOffsetX"));
    y = yOutput.format(_y * Math.cos(-1 * _b) + _x * Math.sin(-1 * _b) + getProperty("workSpaceOffsetY"));

    //writeBlock("; nx: ", nx, " x: ", x);
...
function onLinear5D(_x, _y, _z, _a, _b, _c, feed, feedMode) {
  ...
  var z = zOutput.format(_z + getProperty("workSpaceOffsetZ"));
  var a = aOutput.format(_a);
  var b = bOutput.format(_b);// value to use
  var c = cOutput.format(_c);
